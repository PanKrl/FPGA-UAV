...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../nios2e.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x9100
SOPC_SYSID_FLAG += --sidp=0x9100
ELF_PATCH_FLAG  += --sidp 0x9100

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1705220283
SOPC_SYSID_FLAG += --timestamp=1705220283
ELF_PATCH_FLAG  += --timestamp 1705220283
