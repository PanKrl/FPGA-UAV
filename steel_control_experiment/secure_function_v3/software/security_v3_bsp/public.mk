...
# setting SOPC_SYSID_BASE_ADDRESS is 0x41140
SOPC_SYSID_FLAG += --sidp=0x41140
ELF_PATCH_FLAG  += --sidp 0x41140

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1705554343
SOPC_SYSID_FLAG += --timestamp=1705554343
ELF_PATCH_FLAG  += --timestamp 1705554343
