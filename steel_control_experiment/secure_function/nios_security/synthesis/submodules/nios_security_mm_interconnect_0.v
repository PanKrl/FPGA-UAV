...
module nios_security_mm_interconnect_0 (
	...
	wire   [9:0] cmd_mux_src_channel;                                                          // cmd_mux:src_channel -> JTAG_avalon_jtag_slave_agent:cp_channel
	...
	wire   [9:0] cmd_mux_001_src_channel;                                                      // cmd_mux_001:src_channel -> ID_control_slave_agent:cp_channel
	...
	wire  [96:0] cmd_mux_003_src_data;                                                         // cmd_mux_003:src_data -> UART_s1_agent:cp_data
	...
	wire   [9:0] cmd_mux_004_src_channel;                                                      // cmd_mux_004:src_channel -> RAM_s1_agent:cp_channel
	...
	wire   [9:0] cmd_mux_005_src_channel;                                                      // cmd_mux_005:src_channel -> STOP_s1_agent:cp_channel
	...
	wire  [97:0] duty_s1_agent_rf_source_data;                                                 // DUTY_s1_agent:rf_source_data -> DUTY_s1_agent_rsp_fifo:in_data
	...
	wire  [97:0] duty_s1_agent_rsp_fifo_out_data;                                              // DUTY_s1_agent_rsp_fifo:out_data -> DUTY_s1_agent:rf_sink_data
	...
	wire  [96:0] cmd_mux_007_src_data;                                                         // cmd_mux_007:src_data -> DUTY_s1_agent:cp_data
	wire         cmd_mux_007_src_ready;                                                        // DUTY_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire   [9:0] cmd_mux_007_src_channel;                                                      // cmd_mux_007:src_channel -> DUTY_s1_agent:cp_channel
	...
	wire  [96:0] cmd_mux_008_src_data;                                                         // cmd_mux_008:src_data -> PERIOD_s1_agent:cp_data
	wire         cmd_mux_008_src_ready;                                                        // PERIOD_s1_agent:cp_ready -> cmd_mux_008:src_ready
	wire   [9:0] cmd_mux_008_src_channel;                                                      // cmd_mux_008:src_channel -> PERIOD_s1_agent:cp_channel
	...
	wire  [96:0] cmd_mux_009_src_data;                                                         // cmd_mux_009:src_data -> SW_s1_agent:cp_data
	wire         cmd_mux_009_src_ready;                                                        // SW_s1_agent:cp_ready -> cmd_mux_009:src_ready
	wire   [9:0] cmd_mux_009_src_channel;                                                      // cmd_mux_009:src_channel -> SW_s1_agent:cp_channel
	...
	wire  [96:0] uart_s1_agent_rp_data;                                                        // UART_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [96:0] duty_s1_agent_rp_data;                                                        // DUTY_s1_agent:rp_data -> router_009:sink_data
	...
	wire  [96:0] period_s1_agent_rp_data;                                                      // PERIOD_s1_agent:rp_data -> router_010:sink_data
	...
	wire  [96:0] sw_s1_agent_rp_data;                                                          // SW_s1_agent:rp_data -> router_011:sink_data
