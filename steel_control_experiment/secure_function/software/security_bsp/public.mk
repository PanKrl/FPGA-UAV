...
# setting SOPC_SYSID_BASE_ADDRESS is 0x41090
SOPC_SYSID_FLAG += --sidp=0x41090
ELF_PATCH_FLAG  += --sidp 0x41090

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1703661907
SOPC_SYSID_FLAG += --timestamp=1703661907
ELF_PATCH_FLAG  += --timestamp 1703661907
