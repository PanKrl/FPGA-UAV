...
(
    ...
    localparam PAD15 = log2ceil(64'h41110 - 64'h41100); 
    localparam PAD16 = log2ceil(64'h41120 - 64'h41110); 
    localparam PAD17 = log2ceil(64'h41130 - 64'h41120); 
    localparam PAD18 = log2ceil(64'h41140 - 64'h41130); 
    localparam PAD19 = log2ceil(64'h41148 - 64'h41140); 
    localparam PAD20 = log2ceil(64'h41150 - 64'h41148); 
    // -------------------------------------------------------
    ...
    // ( 0x41100 .. 0x41110 )
    if ( {address[RG:PAD15],{PAD15{1'b0}}} == 19'h41100   ) begin
    ...
    // ( 0x41120 .. 0x41130 )
    if ( {address[RG:PAD17],{PAD17{1'b0}}} == 19'h41120   ) begin
            src_channel = 21'b000000000000001000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 3;
    end

    // ( 0x41130 .. 0x41140 )
    if ( {address[RG:PAD18],{PAD18{1'b0}}} == 19'h41130   ) begin
            src_channel = 21'b000000000000000100000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 18;
    end

    // ( 0x41140 .. 0x41148 )
    if ( {address[RG:PAD19],{PAD19{1'b0}}} == 19'h41140  && read_transaction  ) begin
            src_channel = 21'b000000000000000000010;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 1;
    end

    // ( 0x41148 .. 0x41150 )
    if ( {address[RG:PAD20],{PAD20{1'b0}}} == 19'h41148   ) begin
