...
// -------------------------------------------------------------
// 
// Module: nfp_convert_single_to_fix_32_En0
// Source Path: PID_Attitude_ver7_5/Motor_Controller/nfp_convert_single_to_fix_32_En0
// Hierarchy Level: 2
// 
...
module nfp_convert_single_to_fix_32_En0
  ...
  wire [55:0] Data_Type_Conversion_out1;  // ufix56_En24
  ...
  wire [55:0] Shift_Arithmetic1_out1;  // ufix56_En24
  wire Compare_To_Zero1_out1_1;
  wire Compare_To_Zero_out1_1;
  wire Logical_Operator_out1;
  wire [55:0] Bit_Set_out1;  // ufix56_En24
  wire signed [8:0] shift_arithmetic2_zerosig;  // sfix9
  wire signed [8:0] shift_arithmetic2_selsig;  // sfix9
  wire [55:0] Switch2_out1_1;  // ufix56_En24
  wire [55:0] Data_Type_Conversion1_out1_1;  // ufix56_En24
  ...
  wire [55:0] Shift_Arithmetic2_out1;  // ufix56_En24
  wire [55:0] Switch1_out1;  // ufix56_En24
  wire signed [56:0] Data_Type_Conversion1_out1_2;  // sfix57_En24
  wire signed [57:0] Unary_Minus_cast;  // sfix58_En24
  wire signed [57:0] Unary_Minus_cast_1;  // sfix58_En24
  wire signed [56:0] Unary_Minus_out1;  // sfix57_En24
  wire signed [56:0] Switch1_out1_1;  // sfix57_En24
  ...
  assign Data_Type_Conversion_out1 = {31'b0, {Data_Type_Conversion1_out1, 1'b0}};
  ...
  assign Compare_To_Zero1_out1_1 = Shift_Arithmetic1_out1 == 56'h00000000000000;



  assign Compare_To_Zero_out1_1 = Data_Type_Conversion_out1 != 56'h00000000000000;
  ...
  assign Bit_Set_out1 = Shift_Arithmetic1_out1 | 56'h00000000000001;
  ...
  assign Data_Type_Conversion1_out1_1 = {31'b0, {Data_Type_Conversion1_out1, 1'b0}};
  ...
  assign Unary_Minus_cast = {Data_Type_Conversion1_out1_2[56], Data_Type_Conversion1_out1_2};
  assign Unary_Minus_cast_1 =  - (Unary_Minus_cast);
  assign Unary_Minus_out1 = Unary_Minus_cast_1[56:0];
  ...
  assign Data_Type_Conversion2_out1 = Switch1_out1_1[55:24];



  assign nfp_out = Data_Type_Conversion2_out1;

endmodule  // nfp_convert_single_to_fix_32_En0
