...
// -------------------------------------------------------------
// 
// Module: nfp_convert_sfix_32_En20_to_single
// Source Path: PID_Attitude_ver7_5/PID_Controller_Roll/nfp_convert_sfix_32_En20_to_single
// Hierarchy Level: 2
// 
...
module nfp_convert_sfix_32_En20_to_single
  ...
  input   signed [31:0] nfp_in;  // sfix32_En20
  ...
  wire [31:0] Delay_out1_dtc;  // ufix32_En20
  wire signed [32:0] Unary_Minus_cast;  // sfix33_En20
  wire signed [32:0] Unary_Minus_cast_1;  // sfix33_En20
  wire signed [31:0] Unary_Minus_out1;  // sfix32_En20
  wire [31:0] Unary_Minus_out1_dtc;  // ufix32_En20
  wire [31:0] Switch_out1;  // ufix32_En20
  wire [127:0] Data_Type_Conversion_out1;  // ufix128_En20
  ...
  wire [127:0] Shift_Arithmetic_out1;  // ufix128_En20
  ...
  assign CompareToZero1_out1 = nfp_in == 32'sb00000000000000000000000000000000;
  ...
  assign Compare_To_Zero_out1 = nfp_in < 32'sb00000000000000000000000000000000;
  ...
  assign Unary_Minus_cast = {nfp_in[31], nfp_in};
  ...
  assign Constant_out1 = 8'sb01101010;
...
endmodule  // nfp_convert_sfix_32_En20_to_single
