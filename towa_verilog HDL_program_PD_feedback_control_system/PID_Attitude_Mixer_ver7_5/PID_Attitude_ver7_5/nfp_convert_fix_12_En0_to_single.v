...
// -------------------------------------------------------------
// 
// Module: nfp_convert_fix_12_En0_to_single
// Source Path: PID_Attitude_ver7_5/Mixer/nfp_convert_fix_12_En0_to_single
// Hierarchy Level: 2
// 
...
module nfp_convert_fix_12_En0_to_single
  ...
  wire [11:0] Unary_Minus_1;  // ufix12
  wire signed [12:0] Unary_Minus_2;  // sfix13
  wire [11:0] Unary_Minus_out1;  // ufix12
  ...
  assign CompareToZero1_out1 = nfp_in == 12'b000000000000;
  ...
  assign Data_Type_Conversion1_out1 = nfp_in;
  ...
  assign Switch_out1 = (Logical_Operator_out1 == 1'b0 ? nfp_in :
              Unary_Minus_out1);



  assign Data_Type_Conversion_out1 = {116'b0, Switch_out1};
  ...
  assign Shift_Arithmetic_out1 = Data_Type_Conversion_out1 <<< dynamic_shift_1;
...
endmodule  // nfp_convert_fix_12_En0_to_single
