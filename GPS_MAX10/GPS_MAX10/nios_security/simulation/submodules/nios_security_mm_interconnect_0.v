...
module nios_security_mm_interconnect_0 (
		...
		output wire [1:0]  GPS_s1_address,                           //                             GPS_s1.address
		input  wire [31:0] GPS_s1_readdata,                          //                                   .readdata
	...
	wire  [31:0] gps_s1_agent_m0_readdata;                                                     // GPS_s1_translator:uav_readdata -> GPS_s1_agent:m0_readdata
	wire         gps_s1_agent_m0_waitrequest;                                                  // GPS_s1_translator:uav_waitrequest -> GPS_s1_agent:m0_waitrequest
	wire         gps_s1_agent_m0_debugaccess;                                                  // GPS_s1_agent:m0_debugaccess -> GPS_s1_translator:uav_debugaccess
	wire  [18:0] gps_s1_agent_m0_address;                                                      // GPS_s1_agent:m0_address -> GPS_s1_translator:uav_address
	wire   [3:0] gps_s1_agent_m0_byteenable;                                                   // GPS_s1_agent:m0_byteenable -> GPS_s1_translator:uav_byteenable
	wire         gps_s1_agent_m0_read;                                                         // GPS_s1_agent:m0_read -> GPS_s1_translator:uav_read
	wire         gps_s1_agent_m0_readdatavalid;                                                // GPS_s1_translator:uav_readdatavalid -> GPS_s1_agent:m0_readdatavalid
	wire         gps_s1_agent_m0_lock;                                                         // GPS_s1_agent:m0_lock -> GPS_s1_translator:uav_lock
	wire  [31:0] gps_s1_agent_m0_writedata;                                                    // GPS_s1_agent:m0_writedata -> GPS_s1_translator:uav_writedata
	wire         gps_s1_agent_m0_write;                                                        // GPS_s1_agent:m0_write -> GPS_s1_translator:uav_write
	wire   [2:0] gps_s1_agent_m0_burstcount;                                                   // GPS_s1_agent:m0_burstcount -> GPS_s1_translator:uav_burstcount
	wire         gps_s1_agent_rf_source_valid;                                                 // GPS_s1_agent:rf_source_valid -> GPS_s1_agent_rsp_fifo:in_valid
	wire  [95:0] gps_s1_agent_rf_source_data;                                                  // GPS_s1_agent:rf_source_data -> GPS_s1_agent_rsp_fifo:in_data
	wire         gps_s1_agent_rf_source_ready;                                                 // GPS_s1_agent_rsp_fifo:in_ready -> GPS_s1_agent:rf_source_ready
	wire         gps_s1_agent_rf_source_startofpacket;                                         // GPS_s1_agent:rf_source_startofpacket -> GPS_s1_agent_rsp_fifo:in_startofpacket
	wire         gps_s1_agent_rf_source_endofpacket;                                           // GPS_s1_agent:rf_source_endofpacket -> GPS_s1_agent_rsp_fifo:in_endofpacket
	wire         gps_s1_agent_rsp_fifo_out_valid;                                              // GPS_s1_agent_rsp_fifo:out_valid -> GPS_s1_agent:rf_sink_valid
	wire  [95:0] gps_s1_agent_rsp_fifo_out_data;                                               // GPS_s1_agent_rsp_fifo:out_data -> GPS_s1_agent:rf_sink_data
	wire         gps_s1_agent_rsp_fifo_out_ready;                                              // GPS_s1_agent:rf_sink_ready -> GPS_s1_agent_rsp_fifo:out_ready
	wire         gps_s1_agent_rsp_fifo_out_startofpacket;                                      // GPS_s1_agent_rsp_fifo:out_startofpacket -> GPS_s1_agent:rf_sink_startofpacket
	wire         gps_s1_agent_rsp_fifo_out_endofpacket;                                        // GPS_s1_agent_rsp_fifo:out_endofpacket -> GPS_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_006_src_valid;                                                        // cmd_mux_006:src_valid -> GPS_s1_agent:cp_valid
	wire  [94:0] cmd_mux_006_src_data;                                                         // cmd_mux_006:src_data -> GPS_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                        // GPS_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [6:0] cmd_mux_006_src_channel;                                                      // cmd_mux_006:src_channel -> GPS_s1_agent:cp_channel
	wire         cmd_mux_006_src_startofpacket;                                                // cmd_mux_006:src_startofpacket -> GPS_s1_agent:cp_startofpacket
	wire         cmd_mux_006_src_endofpacket;                                                  // cmd_mux_006:src_endofpacket -> GPS_s1_agent:cp_endofpacket
	...
	wire         gps_s1_agent_rp_valid;                                                        // GPS_s1_agent:rp_valid -> router_008:sink_valid
	wire  [94:0] gps_s1_agent_rp_data;                                                         // GPS_s1_agent:rp_data -> router_008:sink_data
	wire         gps_s1_agent_rp_ready;                                                        // router_008:sink_ready -> GPS_s1_agent:rp_ready
	wire         gps_s1_agent_rp_startofpacket;                                                // GPS_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire         gps_s1_agent_rp_endofpacket;                                                  // GPS_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire         gps_s1_agent_rdata_fifo_src_valid;                                            // GPS_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire  [33:0] gps_s1_agent_rdata_fifo_src_data;                                             // GPS_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire         gps_s1_agent_rdata_fifo_src_ready;                                            // avalon_st_adapter_006:in_0_ready -> GPS_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_006_out_0_valid;                                            // avalon_st_adapter_006:out_0_valid -> GPS_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_006_out_0_data;                                             // avalon_st_adapter_006:out_0_data -> GPS_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_006_out_0_ready;                                            // GPS_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire   [0:0] avalon_st_adapter_006_out_0_error;                                            // avalon_st_adapter_006:out_0_error -> GPS_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (CLK_clk_clk),                              //                      clk.clk
		.reset                  (NIOSII_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (gps_s1_agent_m0_address),                  // avalon_universal_slave_0.address
		.uav_burstcount         (gps_s1_agent_m0_burstcount),               //                         .burstcount
		.uav_read               (gps_s1_agent_m0_read),                     //                         .read
		.uav_write              (gps_s1_agent_m0_write),                    //                         .write
		.uav_waitrequest        (gps_s1_agent_m0_waitrequest),              //                         .waitrequest
		.uav_readdatavalid      (gps_s1_agent_m0_readdatavalid),            //                         .readdatavalid
		.uav_byteenable         (gps_s1_agent_m0_byteenable),               //                         .byteenable
		.uav_readdata           (gps_s1_agent_m0_readdata),                 //                         .readdata
		.uav_writedata          (gps_s1_agent_m0_writedata),                //                         .writedata
		.uav_lock               (gps_s1_agent_m0_lock),                     //                         .lock
		.uav_debugaccess        (gps_s1_agent_m0_debugaccess),              //                         .debugaccess
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (CLK_clk_clk),                              //             clk.clk
		.reset                   (NIOSII_reset_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (gps_s1_agent_m0_address),                  //              m0.address
		.m0_burstcount           (gps_s1_agent_m0_burstcount),               //                .burstcount
		.m0_byteenable           (gps_s1_agent_m0_byteenable),               //                .byteenable
		.m0_debugaccess          (gps_s1_agent_m0_debugaccess),              //                .debugaccess
		.m0_lock                 (gps_s1_agent_m0_lock),                     //                .lock
		.m0_readdata             (gps_s1_agent_m0_readdata),                 //                .readdata
		.m0_readdatavalid        (gps_s1_agent_m0_readdatavalid),            //                .readdatavalid
		.m0_read                 (gps_s1_agent_m0_read),                     //                .read
		.m0_waitrequest          (gps_s1_agent_m0_waitrequest),              //                .waitrequest
		.m0_writedata            (gps_s1_agent_m0_writedata),                //                .writedata
		.m0_write                (gps_s1_agent_m0_write),                    //                .write
		.rp_endofpacket          (gps_s1_agent_rp_endofpacket),              //              rp.endofpacket
		.rp_ready                (gps_s1_agent_rp_ready),                    //                .ready
		.rp_valid                (gps_s1_agent_rp_valid),                    //                .valid
		.rp_data                 (gps_s1_agent_rp_data),                     //                .data
		.rp_startofpacket        (gps_s1_agent_rp_startofpacket),            //                .startofpacket
		...
		.rf_sink_ready           (gps_s1_agent_rsp_fifo_out_ready),          //         rf_sink.ready
		.rf_sink_valid           (gps_s1_agent_rsp_fifo_out_valid),          //                .valid
		.rf_sink_startofpacket   (gps_s1_agent_rsp_fifo_out_startofpacket),  //                .startofpacket
		.rf_sink_endofpacket     (gps_s1_agent_rsp_fifo_out_endofpacket),    //                .endofpacket
		.rf_sink_data            (gps_s1_agent_rsp_fifo_out_data),           //                .data
		.rf_source_ready         (gps_s1_agent_rf_source_ready),             //       rf_source.ready
		.rf_source_valid         (gps_s1_agent_rf_source_valid),             //                .valid
		.rf_source_startofpacket (gps_s1_agent_rf_source_startofpacket),     //                .startofpacket
		.rf_source_endofpacket   (gps_s1_agent_rf_source_endofpacket),       //                .endofpacket
		.rf_source_data          (gps_s1_agent_rf_source_data),              //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_006_out_0_ready),        // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_006_out_0_valid),        //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_006_out_0_data),         //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_006_out_0_error),        //                .error
		.rdata_fifo_src_ready    (gps_s1_agent_rdata_fifo_src_ready),        //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (gps_s1_agent_rdata_fifo_src_valid),        //                .valid
		.rdata_fifo_src_data     (gps_s1_agent_rdata_fifo_src_data),         //                .data
		.m0_response             (2'b00),                                    //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                      //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) gps_s1_agent_rsp_fifo (
		.clk               (CLK_clk_clk),                              //       clk.clk
		.reset             (NIOSII_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (gps_s1_agent_rf_source_data),              //        in.data
		.in_valid          (gps_s1_agent_rf_source_valid),             //          .valid
		.in_ready          (gps_s1_agent_rf_source_ready),             //          .ready
		.in_startofpacket  (gps_s1_agent_rf_source_startofpacket),     //          .startofpacket
		.in_endofpacket    (gps_s1_agent_rf_source_endofpacket),       //          .endofpacket
		.out_data          (gps_s1_agent_rsp_fifo_out_data),           //       out.data
		.out_valid         (gps_s1_agent_rsp_fifo_out_valid),          //          .valid
		.out_ready         (gps_s1_agent_rsp_fifo_out_ready),          //          .ready
		.out_startofpacket (gps_s1_agent_rsp_fifo_out_startofpacket),  //          .startofpacket
		.out_endofpacket   (gps_s1_agent_rsp_fifo_out_endofpacket),    //          .endofpacket
		.csr_address       (2'b00),                                    // (terminated)
		.csr_read          (1'b0),                                     // (terminated)
		.csr_write         (1'b0),                                     // (terminated)
		.csr_readdata      (),                                         // (terminated)
	...
	nios_security_mm_interconnect_0_router_002 router_008 (
		.sink_ready         (gps_s1_agent_rp_ready),                    //      sink.ready
		.sink_valid         (gps_s1_agent_rp_valid),                    //          .valid
		.sink_data          (gps_s1_agent_rp_data),                     //          .data
		.sink_startofpacket (gps_s1_agent_rp_startofpacket),            //          .startofpacket
		.sink_endofpacket   (gps_s1_agent_rp_endofpacket),              //          .endofpacket
		.clk                (CLK_clk_clk),                              //       clk.clk
		.reset              (NIOSII_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_security_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (CLK_clk_clk),                              // in_clk_0.clk
		.in_rst_0_reset (NIOSII_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (gps_s1_agent_rdata_fifo_src_data),         //     in_0.data
		.in_0_valid     (gps_s1_agent_rdata_fifo_src_valid),        //         .valid
		.in_0_ready     (gps_s1_agent_rdata_fifo_src_ready),        //         .ready
