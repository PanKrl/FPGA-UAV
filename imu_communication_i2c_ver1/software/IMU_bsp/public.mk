...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../nios_security.sopcinfo
...
# Design Name 
# setting SOPC_NAME is nios_security
SOPC_NAME := nios_security
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x41170
SOPC_SYSID_FLAG += --sidp=0x41170
ELF_PATCH_FLAG  += --sidp 0x41170

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1715075989
SOPC_SYSID_FLAG += --timestamp=1715075989
ELF_PATCH_FLAG  += --timestamp 1715075989
